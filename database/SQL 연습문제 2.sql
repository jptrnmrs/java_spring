...
create table `bank_transaction`(
	`t_no`			tinyint		primary key auto_increment,
...
# 실습 2-3. 테이블에 아래 그림과 같이 데이터를 입력하시오.
insert into `bank_customer` values ('102-22-51094'  ,'부산의원'	,2,'051-518-1010'	,'부산시 남구'		);
insert into `bank_customer` values ('220-82-52237'  ,'(주)한국전산'	,2,'02-134-1054'	,'서울시 강서구'	);
